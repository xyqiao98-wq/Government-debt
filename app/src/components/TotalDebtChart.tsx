        ...
        formatter: (params: any) => {
          ...
          return `
            ...
            <div style="display:flex;align-items:center;gap:8px;margin:4px 0;">
              ...
              <span style="font-weight:600;">${item.value}万亿</span>
            </div>
          `;
        },
      },
      ...
      series: [
        {
          ...
          data: topTotalDebtProvinces.map(item => ({
            value: Number((item.totalDebt / 10000).toFixed(2)),
          })),
        },
      ],
    };
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-lg font-semibold text-white">债务总量 Top 10</h3>
